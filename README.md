...
$ bin/champsim --warmup_instructions 200000000 --simulation_instructions 500000000 -cloudsuite -traces  ~/path/to/traces/600.perlbench_s-210B.champsimtrace.xz <path to more traces> <more traces>
```
